...
class MapDataset(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        while True:
            ...
            try:
                if isinstance(self._map_func, PicklableWrapper) and type(self._map_func._obj).__name__ == 'OADatasetMapper':
                ...
                print("AttributeError on self._map_func:")
                print(f"{self._map_func}")
            if data is not None:
